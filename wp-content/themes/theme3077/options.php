...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#606364'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '42px', 'lineheight' => '45px', 'face' => 'Limelight', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e14d43'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '38px', 'face' => 'Limelight', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e14d43'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '22px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '82px', 'lineheight' => '70px', 'face' => 'Limelight', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e14d43'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '11px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#5a585c'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '11px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#a8a5aa'));
		return $options;
	}
}
?>
